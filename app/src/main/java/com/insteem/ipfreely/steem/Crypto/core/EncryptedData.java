...
package com.insteem.ipfreely.steem.Crypto.core;
...
/**
 * <p>
 * An instance of EncryptedData is a holder for an initialization vector and
 * encrypted bytes. It is typically used to hold encrypted private key bytes.
 * </p>
 *
 * <p>
 * The initialisation vector is random data that is used to initialise the AES
 * block cipher when the private key bytes were encrypted. You need these for
 * decryption.
 * </p>
 */
public final class EncryptedData {
    ...
    public String toString() {
        return "EncryptedData [initialisationVector=" + Arrays.toString(initialisationVector) + ", encryptedPrivateKey="
