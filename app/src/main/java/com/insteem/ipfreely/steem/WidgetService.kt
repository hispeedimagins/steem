...
import com.insteem.ipfreely.steem.HelperClasses.AllAppWidget
import com.insteem.ipfreely.steem.HelperClasses.AllAppWidgetConfigureActivity
...
import com.insteem.ipfreely.steem.RoomDatabaseApp.RoomRepos.WidgetRepo
import java.util.*
...
//                })
    ...
    public fun Bind(rv:RemoteViews,article:FeedArticleDataHolder.FeedArticleHolder,position:Int){
       ...
       /* holder.article_tag?.setOnClickListener(View.OnClickListener {
        ...
        extras.putString(CentralConstants.passerArticleaDate,article.datespan)
        extras.putString(CentralConstants.passerArticleTitle,article.title)
        extras.putString(CentralConstants.passerArticleDefImg,article.displayImage)
