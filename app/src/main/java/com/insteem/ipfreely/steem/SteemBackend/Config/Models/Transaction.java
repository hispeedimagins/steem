...
import com.insteem.ipfreely.steem.Crypto.CryptoUtils;
...
public class Transaction implements Serializable {
   ...
   // @JsonProperty("extensions")
     ...
     */
    /*@JsonCreator
    public Transaction(@SerializedName("ref_block_num") UShort refBlockNum,
            @SerializedName("ref_block_prefix") UInteger refBlockPrefix,
            @SerializedName("expiration") TimePointSec expirationDate,
            @SerializedName("operations") List<Operation> operations,
            @SerializedName("extensions") List<FutureExtensions> extensions) {
    ...
    //@JsonCreator
    public Transaction(UShort refBlockNum,
            UInteger refBlockPrefix,
    ...
    /*public void validate()  {
        if (this.getExpirationDate().getDateTimeAsTimestamp() > (new Timestamp(System.currentTimeMillis())).getTime()
            ...
            //LOGGER.warn("The configured expiration date for this transaction is to far "
                ...
                .getTime()) {
            throw new RuntimeException("The expiration date can't be in the past.");
        }
