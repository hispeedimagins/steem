...
import com.insteem.ipfreely.steem.HelperClasses.Links
...
class MiscConstants{
    companion object{
        ...
        fun getRandDrawable(context: Context):Drawable?{
            val i = (0..2).random()
            return when(i){
                0 -> ContextCompat.getDrawable(context,R.drawable.default_image_one)
                1 -> ContextCompat.getDrawable(context,R.drawable.default_image_one)
