...
import com.insteem.ipfreely.steem.SteemBackend.Config.Enums.AddressPrefixType;
import com.insteem.ipfreely.steem.SteemBackend.Config.Enums.AssetSymbolType;
import com.insteem.ipfreely.steem.SteemBackend.Config.Enums.PrivateKeyType;
import com.insteem.ipfreely.steem.SteemBackend.Config.Enums.SynchronizationType;
...
import com.insteem.ipfreely.steem.SteemBackend.Config.Models.PrivateKeyStorage;
...
public class SteemJConfig {
    ...
    private static final AccountName Dev_ACCOUNT = new AccountName("hispeedimagins");
    /** The SteemJ version. */
    private static final String STEEMJ_VERSION = "1.0";
    /** The SteemJ App-Name */
    private static final String STEEMJ_NAME = "Steemer";
    /** The inner {@link SteemJConfig} instance. */
    private static SteemJConfig steemJConfigInstance;
    public static final String MARKDOWN = "markdown";
    //public static final String TAG_ERROR_MESSAGE = "You need to provide at least one tag, but not more than five.";
    public static final String TAG_ERROR_MESSAGE = "You need to provide at least one tag, but not more than ten.";
    /**
     * Receive a {ink eu.bittrade.libs.steemj.configuration.SteemJConfig
   ...
   /* public void setClientEndpointConfig(ClientEndpointConfig clientEndpointConfig) {
    ...
    public void setDateTime(String dateTimePattern, String timeZoneId) {
        ...
        if (!"GMT".equals(timeZoneId) && "GMT".equals(TimeZone.getTimeZone(timeZoneId).getID())) {
            Log.i("setDateTime", "setDateTime: The timezoneId {} could not be understood - UTC will now be used as a default.");
            this.timeZoneId = "UTC";
        } else {
    ...
    public void setAccountKey(PrivateKeyType privateKeyType,String wifPrivateKey){
        privateKeyStorage.addPrivateKeyToAccount(this.defaultAccount,
                new ImmutablePair<PrivateKeyType, String>(privateKeyType, wifPrivateKey));
    }
    ...
    public void setDevWeight(short devWeight){
    ...
    public static AccountName getDev_ACCOUNT(){
        return Dev_ACCOUNT;
    }
