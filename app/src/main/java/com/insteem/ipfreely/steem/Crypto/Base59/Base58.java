 ...
 */
public class Base58 {
    /** The list of allowed characters for a base58 String. */
     ...
     *            A {@link Base58ChecksumProvider} implementation which is used
     *            to calculate the actual checksum of the input.
     * @return the original data bytes.
     * throws AddressFormatException
     *             if the input is not base 58 or the checksum does not
     *             validate.
     */
    public static byte[] decodeChecked(String input, Base58ChecksumProvider checksumProvider) {
