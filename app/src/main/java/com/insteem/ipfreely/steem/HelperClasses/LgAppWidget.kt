...
import com.insteem.ipfreely.steem.ArticleActivity
...
import com.insteem.ipfreely.steem.MiscConstants.Companion.getBitmap
...
class LgAppWidget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if(intent.action == LgAppWidget.sb_refresh){
            ...
            myIntent.putExtra(CentralConstants.passerArticleaDate,intent.getStringExtra(CentralConstants.passerArticleaDate))
            myIntent.putExtra(CentralConstants.passerArticleTitle,intent.getStringExtra(CentralConstants.passerArticleTitle))
            myIntent.putExtra(CentralConstants.passerArticleDefImg,intent.getStringExtra(CentralConstants.passerArticleDefImg))
    ...
    companion object {
       ...
       /*fun addCard(context:Context) {
        ...
        public fun Bind(article: FeedArticleDataHolder.FeedArticleHolder, appWidgetId:Int,mContext: Context):RemoteViews{
            ...
            openintent.putExtra(CentralConstants.passerArticleaDate,article.datespan)
            openintent.putExtra(CentralConstants.passerArticleTitle,article.title)
            openintent.putExtra(CentralConstants.passerArticleDefImg,article.displayImage)
