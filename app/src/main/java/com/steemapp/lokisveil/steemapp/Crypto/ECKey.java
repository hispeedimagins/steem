...
import com.steemapp.lokisveil.steemapp.Crypto.core.EncryptedData;
import com.steemapp.lokisveil.steemapp.Crypto.core.KeyCrypter;
import com.steemapp.lokisveil.steemapp.Crypto.core.KeyCrypterException;
import com.steemapp.lokisveil.steemapp.Crypto.core.LazyECPoint;
import com.steemapp.lokisveil.steemapp.Crypto.core.LinuxSecureRandom;
...
public class ECKey {
     ...
     * {@link com.google.common.primitives.UnsignedBytes#lexicographicalComparator()}
     */
     ...
     * by OpenSSL and stored by Bitcoin Core in its wallet. Note that this is
     * slow because it requires an EC point multiply.
     */
    ...
    /**
     * Returns true if this key is watch only, meaning it has a public key but
     * no private key.
     */
     ...
     * Note that an address is derived from the RIPEMD-160 hash of the public
     ...
     * @throws ECKey.MissingPrivateKeyException
    ...
    protected ECDSASignature doSign(Sha256Hash input, BigInteger privateKeyForSigning) {
        if (Secp256k1Context.isEnabled()) {
            try {
                ...
                Log.e("doSign", "doSign: Caught AssertFailException inside secp256k1");
    ...
    public static boolean verify(byte[] data, ECDSASignature signature, byte[] pub) {
        ...
        if (Secp256k1Context.isEnabled()) {
            try {
                ...
                Log.e("verify", "verify: Caught AssertFailException inside secp256k1" );
                return false;
            }
        }
        ...
        try {
            ...
            Log.e("NullPointerException","Caught NPE inside bouncy castle");
            return false;
        }
    }
    ...
    public static boolean verify(byte[] data, byte[] signature, byte[] pub) {
        if (Secp256k1Context.isEnabled()) {
            try {
                ...
                Log.e("verify","Caught AssertFailException inside secp256k1");
                return false;
            }
        }
    ...
    public static boolean encryptionIsReversible(ECKey originalKey, ECKey encryptedKey, KeyCrypter keyCrypter,
        ...
        try {
            ...
            if (!Arrays.equals(originalPrivateKeyBytes, rebornKeyBytes)) {
                Log.e("encryptionIsReversible", "encryptionIsReversible: The check that encryption could be reversed failed for {}");
                return false;
            }
            return true;
        } catch (KeyCrypterException kce) {
            Log.e("KeyCrypterException", kce.getMessage());
            return false;
        }
    }
     ...
     * key bytes are missing or would have to be derived (for the HD key case).
     */
    @Nullable
    ...
    public String getPrivateKeyAsWiF(Integer privateKeyHeader) {
        return getPrivateKeyEncoded(privateKeyHeader).getKey().toString();
    }
