...
public class VoteOperation extends Operation {
    ...
    public byte[] toByteArray()  {
        try (ByteArrayOutputStream serializedVoteOperation = new ByteArrayOutputStream()) {
            serializedVoteOperation.write(Utilities.transformIntToVarIntByteArray(OperationType.VOTE_OPERATION.getOrderId()));
            ...
            serializedVoteOperation.write(Utilities.transformShortToByteArray(this.getWeight()));
    ...
    public Map<SignatureObject, PrivateKeyType> getRequiredAuthorities(
        ...
        //return mergeRequiredAuthorities(requiredAuthoritiesBase,getVoter(),PrivateKeyType.POSTING);
    }
